 ...
 * @param groupid
 */
export let getGroupInfo = (axios, userid) => axios.get(`/shscAdminGroupId?userid=${userid}`);
/**
 * 编辑权限组
 * @param axios
 * @param data
 ...
 * @param id
 */
export let getUserInfo = (axios, userid) => axios.get(`/shscAdminInsert?userid=${userid}`);
/**
 * 获取热门关键词
 * @param axios
 * @param search
